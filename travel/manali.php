...
<body style="background-color: aliceblue;"> <!-- Added background color -->
    ...
    <div class="package-details">
        <div class="package-image">
            <img src="https://www.indiadrivertours.com/wp-content/uploads/2017/06/tpkg-manalitour.jpg"
                alt="Package Image">
        </div>
        <div class="package-info">
            <h2>Manali</h2>
            <p><b>Number of Days:</b> 10</p>
            <p>Description: Manali, nestled in the Himalayas, is a gem in Himachal Pradesh. This town, at 2,050 meters,
                is a haven for backpackers, honeymooners, and nature enthusiasts. The Beas River snakes through Manali,
                flanked by snow-capped peaks and verdant valleys. Adventure seekers flock to Solang Valley for skiing,
                paragliding, and rafting. Spiritual sites abound, with the 15th-century Hidimba Devi Temple and Vashisht
                Temple with its hot springs drawing visitors. Rohtang Pass, at nearly 4,000 meters, offers stunning
                vistas but can get crowded. Manali's charm extends beyond. </p>
            <div class="col-sm-6">
    ...
    <a href="locationDisplay.php?destination=Manali" class="buy-now-button">Buy Now</a>
