...
<body style="background-color: aliceblue;"> <!-- Added background color -->
    ...
    <div class="package-details">
        <div class="package-image">
            <img src="https://thecrazymountaineers.com/images/packages/45/gallery/Leh_Ladakh_Road_trip_2.jpg"
                alt="Package Image">
        </div>
        <div class="package-info">
            <h2>Leh Ladakh</h2>
            <p><b>Number of Days:</b> 15</p>
            <p><b>Description:</b> Ladakh, nicknamed "The Land of High Passes," is a breathtaking adventure paradise
                nestled in the lofty embrace of the Himalayas. Leh, the capital, perched at a staggering altitude,
                offers a unique blend of Tibetan Buddhist culture and dramatic landscapes. Explore ancient monasteries
                like Hemis, perched atop a hill, or wander the bustling bazaars filled with colorful prayer flags and
                local handicrafts. Adventure seekers can conquer the Khardung La, the world's highest motorable road,
                for jaw-dropping vistas. Pangong Tso, a high-altitude lake known for its mesmerizing color-changing
                waters, is an iconic sight. For a taste of tranquility, cycle through the serene Nubra Valley, dotted
                with traditional villages and apricot orchards. Leh Ladakh beckons trekkers with challenging routes like
                the Markha Valley trek, offering stunning mountain scenery. Warm Ladakhi hospitality and a vibrant
                culture, evident in colorful festivals like Matsuri, complete the experience. Ladakh promises an
                unforgettable adventure, a place where nature reigns supreme and ancient traditions endure.</p>
            <div class="col-sm-6">
    ...
    <a href="locationDisplay.php?destination=LehLadakh" class="buy-now-button">Buy Now</a>
