...
<body style="background-color: aliceblue;"> <!-- Added background color -->
    ...
    <div class="package-details">
        <div class="package-image">
            <img src="https://media.easemytrip.com/media/Blog/India/637915846722669356/637915846722669356B5c7WW.jpg"
                alt="Package Image">
        </div>
        <div class="package-info">
            <h2>Shimla</h2>
            <p><b>Number of Days: </b>8</p>
            <p><b>Description:</b> Nestled amidst the verdant Himalayas, Shimla, the capital of Himachal Pradesh, exudes
                a colonial charm. Once the summer capital of British India, Shimla's legacy lives on in its grand
                architecture. The Ridge, a bustling promenade with panoramic views, is the heart of the town. Here, you
                can stroll past colonial buildings like the neo-Gothic Christ Church or shop for souvenirs at Lakkar
                Bazaar, a haven for wooden handicrafts. Adventure awaits on Jakhoo Hill, the highest point, offering a
                challenging hike and a chance to spot the Hanuman Temple. Shimla's Toy Train, a UNESCO World Heritage
                Site, takes you on a scenic journey through the hills. For a touch of history, explore the Viceregal
                Lodge, a former residence of British Viceroys. Beyond the main attractions, Shimla offers tranquility in
                Summer Hill, a charming suburb with walking trails and horseback riding opportunities. Foodies can
                indulge in local delicacies at bustling cafes along the Mall Road. Whether you seek cultural immersion,
                historical exploration, or scenic beauty, Shimla's magic awaits.</p>
            <div class="col-sm-6">
    ...
    <a href="locationDisplay.php?destination=Shimla" class="buy-now-button">Buy Now</a>
