...
<body style="background-color: aliceblue;"> <!-- Added background color -->
    ...
    <div class="package-details">
        <div class="package-image">
            <img src="https://media.istockphoto.com/id/1159951855/photo/medieval-architecture-at-gadi-sagar-lake-jaisalmer-rajasthan-india-at-sunrise.jpg?s=612x612&w=0&k=20&c=cA1bTkrSvmK4R1HjD-Cg5Si96PLPgl8qrYbRTRBFZ_k="
                alt="Package Image">
        </div>
        <div class="package-info">
            <h2>Rajasthan</h2>
            <p><b>Number of Days:</b> 10</p>
            <p><b>Description:</b> Rajasthan, India's majestic "Land of Kings," unfolds like a vibrant tapestry woven
                with history, culture, and adventure. Towering forts like Mehrangarh in Jodhpur seem to rise from the
                golden sands, whispering tales of a bygone era. Udaipur, the "City of Lakes," beckons with its romantic
                charm, where fairy-tale palaces like the Lake Palace shimmer on serene waters. Jaipur, the captivating
                "Pink City," enthralls visitors with its rose-colored buildings and the iconic Hawa Mahal, or "Palace of
                Winds," a masterpiece of intricate architecture. Seek thrills in Ranthambore National Park, where
                majestic tigers roam, or lose yourself in the vast Thar Desert. Camp under a canopy of stars, embark on
                an adventurous camel safari, or immerse yourself in the rich cultural tapestry. Whether you seek a
                journey through history, a thrilling adventure, or a deep dive into a vibrant culture, Rajasthan
                promises an experience that will linger long after you depart.</p>
            <div class="col-sm-6">
    ...
    <a href="locationDisplay.php?destination=Rajasthan" class="buy-now-button">Buy Now</a>
