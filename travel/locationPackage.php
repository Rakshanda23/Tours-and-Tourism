        ...
        <body style="background-color: aliceblue;"> <!-- Added background color -->
            ...
            <div class="package-details">
                <div class="package-image">
                    <img src="<?php echo $row['img'] ?>" alt="Package Image">
                </div>
                <div class="package-info">
                    <p><b>Name of package:</b> <?php echo $row["name"] ?></p>
                    <p><b>Number of Days:</b> <?php echo $row["days"] ?></p>
                    <p><b>Number of People:</b> <?php echo $row["people"] ?></p>
                    <p><b>Name of Train:</b> <?php echo $row["train"] ?></p>
                    <p><b>Name of Hotel:</b> <?php echo $row["hotel"] ?></p>
                    <p><b>
