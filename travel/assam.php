...
<div class="spacer">a</div>
        ...
        <div class="package-details">
            <div class="package-image">
                <img src="https://menonimus.org/wp-content/uploads/2021/01/The-Natural-Beauty-of-Assam-An-Essay.jpg" alt="Package Image">
            </div>
            <div class="package-info">
                <h2>Assam</h2>
                <p><b>Number of Days:</b> 6</p>
                <p><b>Description:</b> Assam, in India's northeast, is a treasure trove for nature lovers and culture enthusiasts.  Kaziranga National Park, a UNESCO World Heritage Site, is a haven for one-horned rhinos and diverse wildlife, best explored on an exciting jeep safari.  Majuli, the world's largest river island, offers a glimpse into Assamese life with its traditional villages, weaving communities, and laid-back charm.  Guwahati, Assam's largest city, pulsates with energy. Visit the Kamakhya Temple, a revered Hindu pilgrimage site, or explore the Assam State Museum to delve into the region's rich history.  Nature enthusiasts can trek through Manas National Park, a biosphere reserve teeming with elephants, tigers, and exotic birds.  Assam's verdant beauty extends to tea plantations, where you can witness the process of creating this famous beverage.  Beyond the sights, delve into Assamese culture with Bihu, a vibrant harvest festival, or savor the unique flavors of Assamese cuisine, known for its use of fish, lentils, and fresh herbs. Assam promises an unforgettable experience, where nature's bounty meets cultural richness and age-old traditions.</p>
                <div class="col-sm-6">			
        ...
        <a href="assampackagedisplay.php" class="buy-now-button">Buy Now</a>
